//
//  NoticViewController.swift
//  ITSC
//
//  Created by aaaabang on 2021/11/16.
//

import UIKit
import SwiftSoup

class NoticViewController: UITableViewController, ContentDelegate {
    ...
    func fetchData() {
        ...
        var url:URL
        if page == 1{
            url = URL(string: "https://itsc.nju.edu.cn/tzgg/list.htm")!
        }else{
            url = URL(string: "https://itsc.nju.edu.cn/tzgg/list\(page).htm")!
        }
