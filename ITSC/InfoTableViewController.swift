...
import UIKit
import SwiftSoup
class InfoTableViewController: UITableViewController,ContentDelegate  {
    ...
    func fetchData() {
        ...
        var url:URL
        if page == 1{
            url = URL(string: "https://itsc.nju.edu.cn/wlyxqk/list.htm")!
        }else{
            url = URL(string: "https://itsc.nju.edu.cn/wlyxqk/list\(page).htm")!
        }
